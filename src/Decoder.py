...
#         output_alphas_attention_wght = None
#         output_alphas_attention_wght = torch.matmul(embedded[0], encoder_outputs.T)

#         attn_weights = F.softmax(output_alphas_attention_wght, dim = 1)
#         attn_applied = torch.bmm(attn_weights.unsqueeze(0),encoder_outputs.unsqueeze(0))
